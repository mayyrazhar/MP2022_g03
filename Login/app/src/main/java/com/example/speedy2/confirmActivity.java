...
public class confirmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ic.setText(iic);
        phoneNumber.setText(iphonenumber);
        carType.setText(icartype);
        carName.setText(icarname);
        reserveDate.setText(ireservedate);
        duration.setText(iduration+" Days");
